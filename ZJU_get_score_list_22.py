...
def GPAto4(df):
    ...
    for idx, row in df.iterrows():
        ...
        if score.isdigit():
            ...
            if score_num >= 95:
                df.at[idx, '4.3分制绩点'] = 4.3
            elif 92 <= score_num <= 94:
                df.at[idx, '4.3分制绩点'] = 4.2
            elif 89 <= score_num <= 91:
                df.at[idx, '4.3分制绩点'] = 4.1
            elif 86 <= score_num <= 88:
                df.at[idx, '4.3分制绩点'] = 4.0
            elif 83 <= score_num <= 85:
                df.at[idx, '4.3分制绩点'] = 3.9
            elif 80 <= score_num <= 82:
                df.at[idx, '4.3分制绩点'] = 3.6
            elif 77 <= score_num <= 79:
                df.at[idx, '4.3分制绩点'] = 3.3
            elif 74 <= score_num <= 76:
                df.at[idx, '4.3分制绩点'] = 3.0
            elif 71 <= score_num <= 73:
                df.at[idx, '4.3分制绩点'] = 2.7
            elif 68 <= score_num <= 70:
                df.at[idx, '4.3分制绩点'] = 2.4
            elif 65 <= score_num <= 67:
                df.at[idx, '4.3分制绩点'] = 2.1
            elif 62 <= score_num <= 64:
                df.at[idx, '4.3分制绩点'] = 1.8
            elif 60 <= score_num <= 61:
                df.at[idx, '4.3分制绩点'] = 1.5
            else:
                df.at[idx, '4.3分制绩点'] = 0.0

        # 2. 处理五级制（A/B/C/D/F）
        elif score.upper() in ['A', 'B', 'C', 'D', 'F']:
            grade_map = {'A': 4.1, 'B': 3.5, 'C': 2.5, 'D': 1.5, 'F': 0.0}
            df.at[idx, '4.3分制绩点'] = grade_map[score.upper()]
        ...
        # 4.A+ A A-
            ...
            df.at[idx, '4.3分制绩点'] = grade_map[score]
...
def Score_list(url1):
    ...
    gpa_total_4 = (df_4_filtered['4.3分制绩点'] * df_4_filtered['学分']).sum()
